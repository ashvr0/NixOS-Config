...
hl.bind(mainMod .. " + Q", hl.dsp.exec_cmd("qs ipc call calendar toggle"))
...
hl.bind(mainMod .. " + H", hl.dsp.exec_cmd("qs ipc call clipboard toggle"))
...
-- workspaces Switch
for i = 1, 6 do
    local key = i % 7 -- 10 maps to key 0
